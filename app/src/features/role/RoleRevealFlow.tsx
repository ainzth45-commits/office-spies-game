        ...
        <div className="role-reveal__main">
          ...
          {isJester && (
            <p className="big-callout role-reveal__jester-goal">
              ภารกิจของคุณ: ทำยังไงก็ได้ให้เพื่อน<b>โหวตคุณออก</b> 🃏
              <br />ถ้าโดนโหวตออก — คุณชนะคนเดียว ที่เหลือแพ้หมด!
              <br /><small>แต่ห้ามโป๊ะ! ถ้าใครรู้ว่าคุณตั้งใจอยากโดนโหวต เขาจะไม่โหวตคุณ</small>
            </p>
          )}
        </div>
