...
export const tutorialScenes: TutorialScene[] = [
  ...
  },
  {
    ...
    narration: "ยิ่งขายเก่ง ยิ่งได้เหรียญเยอะ! 🪙 เอาเหรียญมาใช้ในเกม — เปิดโหวต หรือหมุนกาชาลุ้นไอเทม",
  ...
  },
  {
    ...
    narration: "ไอเทมช่วยตอนโหวต เช่น นับเป็น 2 เสียง · ลบเสียงคนอื่น · หรือลดเกณฑ์ให้จับง่ายขึ้น — สุ่มได้จากตู้กาชาเท่านั้น",
  ...
  },
  {
    id: "shop-gacha",
    title: "ตู้กาชาสายลับ",
    narration: "จ่ายเหรียญให้ซุปแล้วหมุนได้เลย ไม่จำกัดครั้ง — ลุ้นไอเทม เหรียญ โจทย์เชาว์ หรือเกราะ · กดดูได้ว่าในตู้มีอะไรบ้าง",
